# Estonian Competition MCP

**Estonian competition data for AI compliance tools.**
...
**Endpoint:** `https://mcp.ansvar.eu/estonian-competition/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add estonian-competition-mcp --transport http https://mcp.ansvar.eu/estonian-competition/mcp` |
...
```json
{
  "mcpServers": {
    "estonian-competition-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/estonian-competition/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/estonian-competition-mcp
```
...
```json
{
  "mcpServers": {
    "estonian-competition-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/estonian-competition-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `ee_comp_search_decisions` | Full-text search across ECA (Konkurentsiamet) enforcement decisions covering abuse of dominance, cartel enforcement, ... |
| `ee_comp_get_decision` | Get a specific ECA decision by case number (e.g., |
| `ee_comp_search_mergers` | Search ECA merger control decisions (koondumise kontroll). Returns merger cases with acquiring party, target, sector,... |
| `ee_comp_get_merger` | Get a specific ECA merger control decision by case number (e.g., |
| `ee_comp_list_sectors` | List all sectors with ECA enforcement activity, including decision counts and merger counts per sector. |
| `ee_comp_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
...
- **Konkurentsiamet (Estonian Competition Authority)** -- Official regulatory authority
...
>
> Regulatory data is sourced from official publications by Konkurentsiamet (Estonian Competition Authority). However:
...
```bash
git clone https://github.com/Ansvar-Systems/estonian-competition-mcp
cd estonian-competition-mcp
npm install
npm run build
npm test
```
